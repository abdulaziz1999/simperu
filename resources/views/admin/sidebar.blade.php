                ...
                <ul class="metismenu" id="menu">
                    <li>
                        <a class="font-weight-bold" href="{{ url('/admin') }}" aria-expanded="false">
                            <i class="fa fa-tachometer" aria-hidden="true"></i> <span class="nav-text">Dashbord</span>
                        </a>
                    </li>
                    <li>
                        <a class="has-arrow font-weight-bold" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-table" aria-hidden="true"></i> <span class="nav-text">Master Data</span>
                        </a>
