         ...
         <div class="container text-center">
             <div class="row">
                 ...
                 <div class="col-lg-4 pb-5 wow bounceInDown mt-3 mt-lg-0">
                     <form action="{{route('list-ruangan.store', [$ruangan->id])}}" method="post" class="shadow border p-3 sticky-top" style="border-radius: 1rem; top: 1rem;" enctype="multipart/form-data">
                         @csrf
     ...
     <script>
         ...
         $(document).ready(function() {
             ...
             function get_json(tgl) {
                 $.ajax({
                     ...
                     url: `{{url('')}}/list-ruangan/{{$ruangan->id}}/${tgl}`,
                     method: "POST",
                     data: {
                         tgl: tgl
                     },
         ...
         $('#tgl_masuk').change(function() {
             ...
             $.ajax({
                 ...
                 url: `{{url('')}}/list-ruangan/{{$ruangan->id}}/${id}`,
                 method: "POST",
                 data: {
                     id: id
                 },
